    ...
    public abstract class DayBase<T>
    {
        ...
        private void CheckAndFetchInput(string filename)
        {
            ...
            if (!Directory.Exists(inputDir))
            {
                ...
                {
                    inputDir = Path.Combine(solutionRoot, "adventofcode2024", "input");
                }
            }
                ...
                if (dayMatch.Success && int.TryParse(dayMatch.Groups[1].Value, out int day))
                {
                    ...
                    if (!string.IsNullOrEmpty(sessionCookie))
                    {
                        ...
                        var psi = new ProcessStartInfo
                        {
                            ...
                            Arguments = $"-ExecutionPolicy Bypass -File \"{scriptPath}\" -Day {day} -Year 2024 -SessionCookie \"{sessionCookie}\"",
